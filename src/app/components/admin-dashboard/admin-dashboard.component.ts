...
export class AdminDashboardComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
  @Input() atualizar: any;
...
resizeListener: any;
  ...
  carregarGraficos() {
  this.adminService.getDistribuicaoEscolaridade().subscribe((data: DistribuicaoDashboard & { contagem?: any }) => {
  ...
  this.adminService.getDistribuicaoStatus().subscribe((data: DistribuicaoDashboard & { contagem?: any }) => {
    const contagem = (data as any).contagem ?? data;
    this.pieData = {
